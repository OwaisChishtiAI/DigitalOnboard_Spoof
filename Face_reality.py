...
net = cv2.dnn.readNetFromCaffe(os.getcwd() + "/face_detector/deploy.prototxt",
                               os.getcwd() + "/face_detector/res10_300x300_ssd_iter_140000.caffemodel")

model = load_model(os.getcwd() + "/face_detector/liveness.model")

le = pickle.loads(open(os.getcwd() + "/face_detector/le.pickle", "rb").read())
